...
#----------礦物轉換-----------
execute @e[type=Item,tag=!ore,tag=!coal,tag=!cobblestone,tag=!stone,tag=!iron,tag=!gold,tag=!lapis,tag=!redstone,tag=!diamond,tag=mineral] ~ ~ ~ function windfire:lucky/repeat/mineral/@r
execute @e[type=item,tag=ore,y=101,dy=12,x=980,dx=53,z=939,dz=123] ~ ~ ~ function windfire:lucky/repeat/mineral/ore/diamond@r if @e[type=Item,tag=!mineral,tag=!stone,tag=!redstone,tag=!diamond,tag=!cobblestone,tag=ore]
execute @e[type=item,tag=ore,y=113,dy=11,x=980,dx=53,z=939,dz=123] ~ ~ ~ function windfire:lucky/repeat/mineral/ore/lapis@r if @e[type=Item,tag=!mineral,tag=!stone,tag=!lapis,tag=!cobblestone,tag=ore]
execute @e[type=item,tag=ore,y=124,dy=6,x=980,dx=53,z=939,dz=123] ~ ~ ~ function windfire:lucky/repeat/mineral/ore/gold@r if @e[type=Item,tag=!mineral,tag=!stone,tag=!gold,tag=!cobblestone,tag=ore]
execute @e[type=item,tag=ore,y=130,dy=35,x=980,dx=53,z=939,dz=123] ~ ~ ~ function windfire:lucky/repeat/mineral/ore/iron@r if @e[type=Item,tag=!mineral,tag=!stone,tag=!iron,tag=!cobblestone,tag=ore]

#scoreboard players tag @e[type=item,tag=!coal,tag=!cobblestone,tag=!stone,tag=!iron,tag=!gold,tag=!lapis,tag=!redstone,tag=!diamond,tag=!ore,tag=!mineral] add stoness {Item:{id:"minecraft:cobblestone"}}

#execute @a ~ ~ ~ scoreboard players tag @e[type=item,tag=!coal,tag=!iron,tag=!gold,tag=!lapis,tag=!redstone,tag=!diamond,tag=!ore,tag=!cobblestone,tag=!mineral,tag=!stone,c=1] add cobblestone {Item:{id:"minecraft:cobblestone"}}
#execute @a ~ ~ ~ entitydata @e[type=item,tag=!coal,tag=!iron,tag=!gold,tag=!lapis,tag=!redstone,tag=!diamond,tag=!ore,tag=!mineral,tag=!stone,tag=cobblestone,c=1] {Tags:[cobblestone],PickupDelay:0,Item:{id:"cobblestone",tag:{HideFlags:24,CanPlaceOn:[grass,dirt,farmland,potatoes,fence_gate,fence,trapdoor,wooden_door,oak_stairs,ladder,boat,stone,iron_ore,gold_ore,lapis_ore,redstone_ore,diamond_ore,stone_stairs,obsidian,cobblestone]}}}
#----------石頭套裝------------

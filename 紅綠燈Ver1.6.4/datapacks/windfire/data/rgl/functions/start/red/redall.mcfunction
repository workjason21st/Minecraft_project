...
execute if entity @a[tag=green,tag=tored,tag=!red,team=badred] run scoreboard players remove @e[tag=random7] rglused 1
...
execute if entity @a[tag=green,tag=tored,tag=!red,team=badred] unless entity @a[tag=red,team=bad] run tag @a[tag=green,tag=tored,tag=!red,team=badred,limit=1] add firstred

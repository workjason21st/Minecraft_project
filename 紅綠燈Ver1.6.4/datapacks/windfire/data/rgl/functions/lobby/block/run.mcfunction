...
give @s[tag=!eggboot] minecraft:golden_boots{Unbreakable:1,display:{Name:'[{"text":"漂移靴","bold":true,"color":"gold"}]'},HideFlags:1,Enchantments:[{id:"minecraft:fortune",lvl:7}]} 1
tag @s add eggboot

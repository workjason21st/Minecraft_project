...
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint11,scores={point11detect=1}] run scoreboard players add @s teampoint 1
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint12,scores={point12detect=1}] run scoreboard players add @s teampoint 1
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint13,scores={point13detect=1}] run scoreboard players add @s teampoint 2
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint14,scores={point14detect=1}] run scoreboard players add @s teampoint 2
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint15,scores={point15detect=1}] run scoreboard players add @s teampoint 3
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint5,scores={point5detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint6,scores={point6detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint7,scores={point7detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=1}] as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 6
execute if entity @e[tag=random0,scores={bingorandom=1}] as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 6
execute if entity @e[tag=random0,scores={bingorandom=1}] as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 9
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 7
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 7
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 10
#
execute as @a[tag=!nopoint1,scores={point1detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint2,scores={point2detect=1}] run scoreboard players add @s teampoint 2
execute as @a[tag=!nopoint3,scores={point3detect=1}] run scoreboard players add @s teampoint 3
execute as @a[tag=!nopoint4,scores={point4detect=1}] run scoreboard players add @s teampoint 3
execute if entity @e[tag=random0,scores={bingorandom=0}] as @a[tag=!nopoint5,scores={point5detect=1}] run scoreboard players add @s teampoint 4
execute if entity @e[tag=random0,scores={bingorandom=0}] as @a[tag=!nopoint6,scores={point6detect=1}] run scoreboard players add @s teampoint 4
execute if entity @e[tag=random0,scores={bingorandom=0}] as @a[tag=!nopoint7,scores={point7detect=1}] run scoreboard players add @s teampoint 4
execute if entity @e[tag=random0,scores={bingorandom=0}] as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=0}] as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=0}] as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 6
#
...
execute if entity @a[tag=!nopoint1,scores={point1detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint1,limit=1,scores={point1detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random1]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint1,limit=1,scores={point1detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint2,scores={point2detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint2,limit=1,scores={point2detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random2]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint2,limit=1,scores={point2detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint3,scores={point3detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint3,limit=1,scores={point3detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random3]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint3,limit=1,scores={point3detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint4,scores={point4detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint4,limit=1,scores={point4detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random4]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint4,limit=1,scores={point4detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint5,scores={point5detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint5,limit=1,scores={point5detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random5]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint5,limit=1,scores={point5detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint6,scores={point6detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint6,limit=1,scores={point6detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random6]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint6,limit=1,scores={point6detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint7,scores={point7detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint7,limit=1,scores={point7detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random7]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint7,limit=1,scores={point7detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint8,scores={point8detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint8,limit=1,scores={point8detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random8]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint8,limit=1,scores={point8detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint9,scores={point9detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint9,limit=1,scores={point9detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random9]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint9,limit=1,scores={point9detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @a[tag=!nopoint10,scores={point10detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint10,limit=1,scores={point10detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random10]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint10,limit=1,scores={point10detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
#
execute if entity @e[tag=random0,scores={bingorandom=1..2}] if entity @a[tag=!nopoint11,scores={point11detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint11,limit=1,scores={point11detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random11]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint11,limit=1,scores={point11detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @e[tag=random0,scores={bingorandom=1..2}] if entity @a[tag=!nopoint12,scores={point12detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint12,limit=1,scores={point12detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random12]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint12,limit=1,scores={point12detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @e[tag=random0,scores={bingorandom=1..2}] if entity @a[tag=!nopoint13,scores={point13detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint13,limit=1,scores={point13detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random13]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint13,limit=1,scores={point13detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @e[tag=random0,scores={bingorandom=2}] if entity @a[tag=!nopoint14,scores={point14detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint14,limit=1,scores={point14detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random14]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint14,limit=1,scores={point14detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
execute if entity @e[tag=random0,scores={bingorandom=2}] if entity @a[tag=!nopoint15,scores={point15detect=1}] run tellraw @a ["",{"selector":"@a[tag=!nopoint15,limit=1,scores={point15detect=1}]"},{"text":"取得了","color":"white"},{"selector":"@e[tag=random15]","bold":true,"color":"gold"},{"text":"的目標物，隊伍分數達到了","color":"white"},{"score":{"name":"@a[tag=!nopoint15,limit=1,scores={point15detect=1}]","objective":"teampoint"},"bold":true,"color":"light_purple"},{"text":"分","color":"light_purple"}]
...
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[advancements={newbingo:detect/2=false},tag=!nopoint13,scores={point13detect=1}] run tag @s add nopoint13
...
#
execute as @a[advancements={newbingo:detect/1=false},tag=!nopoint1,scores={point1detect=1}] run tag @s add nopoint1
execute as @a[advancements={newbingo:detect/2=false},tag=!nopoint2,scores={point2detect=1}] run tag @s add nopoint2
execute as @a[advancements={newbingo:detect/34=false},tag=!nopoint3,scores={point3detect=1}] run tag @s add nopoint3
execute as @a[advancements={newbingo:detect/34=false},tag=!nopoint4,scores={point4detect=1}] run tag @s add nopoint4

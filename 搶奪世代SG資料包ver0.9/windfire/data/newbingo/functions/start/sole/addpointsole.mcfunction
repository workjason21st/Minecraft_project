...
execute if entity @e[tag=random0,scores={bingorandom=1..2}] unless entity @e[tag=nopoint13] as @a[tag=!nopoint13,scores={point13detect=1}] run scoreboard players add @s teampoint 2
execute if entity @e[tag=random0,scores={bingorandom=2}] unless entity @e[tag=nopoint14] as @a[tag=!nopoint14,scores={point14detect=1}] run scoreboard players add @s teampoint 2
execute if entity @e[tag=random0,scores={bingorandom=2}] unless entity @e[tag=nopoint15] as @a[tag=!nopoint15,scores={point15detect=1}] run scoreboard players add @s teampoint 3
execute if entity @e[tag=random0,scores={bingorandom=1..2}] unless entity @e[tag=nopoint5] as @a[tag=!nopoint5,scores={point5detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=1..2}] unless entity @e[tag=nopoint6] as @a[tag=!nopoint6,scores={point6detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=1..2}] unless entity @e[tag=nopoint7] as @a[tag=!nopoint7,scores={point7detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=1}] unless entity @e[tag=nopoint8] as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 6
execute if entity @e[tag=random0,scores={bingorandom=1}] unless entity @e[tag=nopoint9] as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 6
execute if entity @e[tag=random0,scores={bingorandom=1}] unless entity @e[tag=nopoint10] as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 9
execute if entity @e[tag=random0,scores={bingorandom=2}] unless entity @e[tag=nopoint8] as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 7
execute if entity @e[tag=random0,scores={bingorandom=2}] unless entity @e[tag=nopoint9] as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 7
execute if entity @e[tag=random0,scores={bingorandom=2}] unless entity @e[tag=nopoint10] as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 10
#addpoint
execute unless entity @e[tag=nopoint1] as @a[tag=!nopoint1,scores={point1detect=1}] run scoreboard players add @s teampoint 1
execute unless entity @e[tag=nopoint2] as @a[tag=!nopoint2,scores={point2detect=1}] run scoreboard players add @s teampoint 2
execute unless entity @e[tag=nopoint3] as @a[tag=!nopoint3,scores={point3detect=1}] run scoreboard players add @s teampoint 3
execute unless entity @e[tag=nopoint4] as @a[tag=!nopoint4,scores={point4detect=1}] run scoreboard players add @s teampoint 3
execute if entity @e[tag=random0,scores={bingorandom=0}] unless entity @e[tag=nopoint5] as @a[tag=!nopoint5,scores={point5detect=1}] run scoreboard players add @s teampoint 4
execute if entity @e[tag=random0,scores={bingorandom=0}] unless entity @e[tag=nopoint6] as @a[tag=!nopoint6,scores={point6detect=1}] run scoreboard players add @s teampoint 4
execute if entity @e[tag=random0,scores={bingorandom=0}] unless entity @e[tag=nopoint7] as @a[tag=!nopoint7,scores={point7detect=1}] run scoreboard players add @s teampoint 4
execute if entity @e[tag=random0,scores={bingorandom=0}] unless entity @e[tag=nopoint8] as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=0}] unless entity @e[tag=nopoint9] as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 5
execute if entity @e[tag=random0,scores={bingorandom=0}] unless entity @e[tag=nopoint10] as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 6
#=

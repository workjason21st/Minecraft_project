...
execute if entity @a[tag=green,tag=tored,tag=!red,team=humanred] run scoreboard players remove 7-0-7-0-000100000000 rglplusredcount 1
...
execute if entity @a[tag=green,tag=tored,tag=!red,team=humanred] unless entity @a[tag=red,team=humanred] run tag @a[tag=green,tag=tored,tag=!red,team=humanred,limit=1] add firstred

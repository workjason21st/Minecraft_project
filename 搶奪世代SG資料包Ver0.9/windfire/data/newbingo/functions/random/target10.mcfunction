#execute as @s[scores={random00=2}] run scoreboard players set 綠寶石 bingolist 6
#execute as @s[scores={random00=4}] run scoreboard players set 黑曜石 bingolist 6
#execute as @s[scores={random00=5}] run scoreboard players set 哭泣的黑曜石 bingolist 6
#execute as @s[scores={random00=7}] run scoreboard players set 空白地圖 bingolist 6
#execute as @s[scores={random00=11}] run scoreboard players set 蛋糕 bingolist 6
#execute as @s[scores={random00=12}] run scoreboard players set 黃金製馬鎧 bingolist 6

execute as @s[scores={random00=1}] run scoreboard players set 附魔金蘋果 bingolist 6
execute as @s[scores={random00=2}] run scoreboard players set 黏性活塞 bingolist 6
execute as @s[scores={random00=3}] run scoreboard players set 附魔台 bingolist 6
execute as @s[scores={random00=4}] run scoreboard players set 不死圖騰 bingolist 6
execute as @s[scores={random00=5}] run scoreboard players set 海靈核心 bingolist 6
execute as @s[scores={random00=6}] run scoreboard players set 鱗甲 bingolist 6

execute as @s[scores={random00=7}] run scoreboard players set 鑽石製馬鎧 bingolist 6
execute as @s[scores={random00=8}] run scoreboard players set 鑽石頭盔 bingolist 6
execute as @s[scores={random00=9}] run scoreboard players set 鑽石胸甲 bingolist 6
execute as @s[scores={random00=10}] run scoreboard players set 鑽石護腿 bingolist 6
execute as @s[scores={random00=11}] run scoreboard players set 鑽石靴子 bingolist 6
execute as @s[scores={random00=12}] run scoreboard players set 粉雪桶 bingolist 6
execute as @s[scores={random00=13}] run scoreboard players set 蜂蜜塊 bingolist 6
#地獄
execute as @s[scores={random00=14,openworld=1}] run scoreboard players set 重生錨 bingolist 6
execute as @s[scores={random00=15,openworld=1}] run scoreboard players set 獄髓碎片 bingolist 6
execute as @s[scores={random00=16,openworld=1}] run scoreboard players set 磁石 bingolist 6
#終
execute as @s[scores={random00=17,openworld=2}] run scoreboard players set 鞘翅 bingolist 6
execute as @s[scores={random00=18,openworld=2}] run scoreboard players set 界伏盒 bingolist 6
execute as @s[scores={random00=19,openworld=2}] run scoreboard players set 龍首 bingolist 6

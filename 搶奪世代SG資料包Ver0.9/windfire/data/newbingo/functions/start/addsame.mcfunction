...
execute if entity @e[tag=random0,scores={bingorandom=1..2}] as @a[tag=!nopoint13,scores={point13detect=1}] run scoreboard players add @s teampoint 1
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint14,scores={point14detect=1}] run scoreboard players add @s teampoint 1
execute if entity @e[tag=random0,scores={bingorandom=2}] as @a[tag=!nopoint15,scores={point15detect=1}] run scoreboard players add @s teampoint 1
#
execute as @a[tag=!nopoint1,scores={point1detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint2,scores={point2detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint3,scores={point3detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint4,scores={point4detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint5,scores={point5detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint6,scores={point6detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint7,scores={point7detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint8,scores={point8detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint9,scores={point9detect=1}] run scoreboard players add @s teampoint 1
execute as @a[tag=!nopoint10,scores={point10detect=1}] run scoreboard players add @s teampoint 1
#
